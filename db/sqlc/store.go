...
type Store interface {
	Querier
	TransfrerTx(ctx context.Context, arg TransferParams) (TransferResult, error)
}
...
func (store *SQLStore) TransfrerTx(ctx context.Context, arg TransferParams) (TransferResult, error) {
