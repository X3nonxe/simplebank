...
// Source: github.com/X3nonxe/simplebank/db/sqlc (interfaces: Store)
...
// TransfrerTx mocks base method.
func (m *MockStore) TransfrerTx(arg0 context.Context, arg1 db.TransferParams) (db.TransferResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransfrerTx", arg0, arg1)
	ret0, _ := ret[0].(db.TransferResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TransfrerTx indicates an expected call of TransfrerTx.
func (mr *MockStoreMockRecorder) TransfrerTx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransfrerTx", reflect.TypeOf((*MockStore)(nil).TransfrerTx), arg0, arg1)
}
